...
\begin{figure}[H]
  ...
  \fbox{\parbox{1\textwidth}{\centering\vspace{1cm}
    [Agile Scrum Methodology Diagram --- replace with actual figure]
    \vspace{1cm}}}
...
\begin{enumerate}[leftmargin=2.5em]
  ...
  \item \textbf{Interactive Map View:}
    ...
    with markers for all available properties. Clicking a marker must open a
    popup with the property image, title, price, and a link to the detail page.
    The map must support clustered search by city using location chip filters.
...
\begin{figure}[H]
  \begin{flushleft}
    [Gantt Chart of NepalHomes Development Schedule --- replace with actual figure]
  \end{flushleft}
...
\begin{figure}[H]
  ...
  \fbox{\parbox{0.82\textwidth}{\centering\vspace{1cm}
    [Use Case Diagram of NepalHomes --- replace with actual figure]
    \vspace{1cm}}}
...
\begin{figure}[H]
  \centering
  \fbox{\parbox{1\textwidth}{\centering\vspace{1cm}
    [Class Diagram of NepalHomes --- replace with actual figure]
    \vspace{1cm}}}
...
the public search results and map view.

\begin{figure}[H]
  \centering
  \fbox{\parbox{1\textwidth}{\centering\vspace{1cm}
    [Sequence Diagram: Property Listing and Approval Flow --- replace with actual figure]
    \vspace{1cm}}}
...
\begin{figure}[H]
  \centering
  \fbox{\parbox{1\textwidth}{\centering\vspace{1cm}
    [Activity Diagram: Buyer Search and Save Workflow --- replace with actual figure]
    \vspace{1cm}}}
...
\begin{figure}[H]
  \centering
  \fbox{\parbox{0.82\textwidth}{\centering\vspace{1cm}
    [Refined Class Diagram of NepalHomes --- replace with actual figure]
    \vspace{1cm}}}
...
popup. City filter chips trigger \texttt{setView()} calls to pan the map to
selected cities.
...
\begin{figure}[H]
  \centering
  \fbox{\parbox{0.82\textwidth}{\centering\vspace{1cm}
    [Component Diagram of NepalHomes --- replace with actual figure]
    \vspace{1cm}}}
...
\begin{figure}[H]
  \centering
  \fbox{\parbox{0.82\textwidth}{\centering\vspace{1cm}
    [Deployment Diagram of NepalHomes --- replace with actual figure]
    \vspace{1cm}}}
...
\begin{figure}[H]
  ...
  \fbox{\parbox{1\textwidth}{\centering\vspace{1.2cm}
    [Home Page (index.html) Screenshot --- replace with actual figure]
    \vspace{1.2cm}}}
...
\begin{figure}[H]
  \centering
  \fbox{\parbox{1\textwidth}{\centering\vspace{1.2cm}
    [Login Page (login.html) Screenshot --- replace with actual figure]
    \vspace{1.2cm}}}
  \caption{Login Page}
  \label{fig:login}
\end{figure}
...
\begin{figure}[H]
  \centering
  \fbox{\parbox{1\textwidth}{\centering\vspace{1.2cm}
    [Search Page (search.html) Screenshot --- replace with actual figure]
    \vspace{1.2cm}}}
...
\begin{figure}[H]
  \centering
  \fbox{\parbox{1\textwidth}{\centering\vspace{1.2cm}
    [Property Detail Page (property.html) Screenshot --- replace with actual figure]
    \vspace{1.2cm}}}
...
\begin{figure}[H]
  \centering
  \fbox{\parbox{1\textwidth}{\centering\vspace{1.2cm}
    [Map View (map.html) Screenshot --- replace with actual figure]
    \vspace{1.2cm}}}
...
\begin{figure}[H]
  \centering
  \fbox{\parbox{1\textwidth}{\centering\vspace{1.2cm}
    [Comparison Tool (compare.html) Screenshot --- replace with actual figure]
    \vspace{1.2cm}}}
...
\begin{figure}[H]
  \centering
  \fbox{\parbox{1\textwidth}{\centering\vspace{1.2cm}
    [Market Insights (insights.html) Screenshot --- replace with actual figure]
    \vspace{1.2cm}}}
...
\begin{figure}[H]
  \centering
  \fbox{\parbox{1\textwidth}{\centering\vspace{1.2cm}
    [Buyer Dashboard (buyer-dashboard.html) Screenshot --- replace with actual figure]
    \vspace{1.2cm}}}
...
\begin{figure}[H]
  \centering
  \fbox{\parbox{1\textwidth}{\centering\vspace{1.2cm}
    [Seller Dashboard (seller-dashboard.html) Screenshot --- replace with actual figure]
    \vspace{1.2cm}}}
...
\begin{figure}[H]
  \centering
  \fbox{\parbox{1\textwidth}{\centering\vspace{1.2cm}
    [Admin Dashboard (admin.html) Screenshot --- replace with actual figure]
    \vspace{1.2cm}}}
