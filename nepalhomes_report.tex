...
\begin{enumerate}[leftmargin=2.5em]
  ...
  \item \textbf{Interactive Map View:}
    ...
    with markers from the hardcoded \texttt{PROPERTIES} array in
    \texttt{js/data.js}. Clicking a marker
...
the public search results. The current \texttt{map.html} implementation still
renders only the static \texttt{PROPERTIES} array.
